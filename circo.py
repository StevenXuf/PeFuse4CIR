...
def get_circo_loader(batch_size=16, split='val', num_workers=0, transform=None):
    ...
    loader = DataLoader(dataset, 
                        ...
                        collate_fn=lambda batch: {
                            ...
                            'target': torch.stack([transform(item['target_img']) if transform is not None else item['target_img'] for item in batch]),
                            ...
                            'all_target_pil': [item['gt_img'] for item in batch],
