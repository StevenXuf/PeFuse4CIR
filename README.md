...
![Model Architecture](./figures/cir.pdf)
...
```bibtex
@inproceedings{pefuse2025cir,
  title     = {PEFUSE: Training-Free Pseudo-Fusion Strategies for Composed Image Retrieval via Diffusion and Multimodal Large Language Models},
